...
//
var stores = {
  Argv: require('./nconf/stores/argv').Argv,
  Env: require('./nconf/stores/env').Env,
  File: require('./nconf/stores/file').File,
  Literal: require('./nconf/stores/literal').Literal,
  Memory: require('./nconf/stores/memory').Memory
};
